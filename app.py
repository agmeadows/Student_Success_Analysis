...
class Questions(db.Model):
    ...
    def __init__(self,ALLGRADEX, SEGRADES,CENREG,SCH_TYPE,EDCPUB,EDCCAT,EDCREL,EDCPRI,
...
def add_record():
    ...
    if form1.validate_on_submit():
        ...
        record = Questions(ALLGRADEX, FODINNERX, FOREADTOX, FORDDAYX, price, updated)
        # Flask-SQLAlchemy magic adds record to database
        db.session.add(record)
        db.session.commit()
        # create a message to send to the template
        message = f"Your questions have been submitted."
...
def edit_result():
    ...
    if form1.validate_on_submit():
        ...
        db.session.commit()
        # create a message to send to the template
        message = f"Your questions have been updated."
