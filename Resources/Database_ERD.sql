...
CREATE TABLE [NHES_19_PFI] (
    ...
    CONSTRAINT [PK_NHES_19_PFI] PRIMARY KEY CLUSTERED (
        [id] ASC
    )
)
...
ALTER TABLE [Surveys] WITH CHECK ADD CONSTRAINT [FK_Surveys_id] FOREIGN KEY([id])
REFERENCES [NHES_19_PFI] ([id])

ALTER TABLE [Surveys] CHECK CONSTRAINT [FK_Surveys_id]
